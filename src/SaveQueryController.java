...
public class SaveQueryController {
    ...
    private void deleteFromTempJson(String item, ListView<String> listView) {
        ...
        try {
            ...
            if (content.isEmpty() || !content.startsWith("[")) {
                showPopup("Warning: Temp.json is empty or invalid.", "Error");
                return;
            }
            ...
            if (itemRemoved) {
                ...
                showPopup("Item not found in Temp.json: " + item, "Error");
            }
        } catch (Exception e) {
            showPopup("Error removing from Temp.json: " + e.getMessage(), "Error");
        }
    }
    ...
    private void moveToDeployed(String item) {
        ...
        if (sourceFile.exists()) {
            if (sourceFile.renameTo(destinationFile)) { // Move file
                ...
                showPopup("Failed to move: " + item, "Error");
            }
        } else {
            showPopup("File not found: " + item, "Error");
        }
    }
    ...
    private void openQuery(String item, String queryType) {
        try {
            ...
            showPopup("Error opening query editor: " + e.getMessage(), "Error");
        }
    }
    ...
    private void loadQueryListFromJson(ListView<String> listView, String jsonFileName) {
        ...
        if (jsonFile.exists()) {
            try {
                ...
                if (content.isEmpty() || !content.startsWith("[")) {
                    showPopup("Warning: Temp.json is empty or invalid. Resetting.", "Error");
                ...
                showPopup("Error loading Temp.json: " + e.getMessage(), "Error");
            }
        }
    }
    ...
    public void saveQuery() {
        ...
        if (taskName.isEmpty() || databaseName.isEmpty() || query.isEmpty()) {
            showPopup("Please Enter All Details", "Error");
            return;
        }
    ...
    private void saveLongQuery(String taskName, String databaseName, String query) {
        ...
        try (FileWriter writer = new FileWriter(file)) {
            ...
            e.printStackTrace();
            showPopup("Failed to save the query!", "Error");
        }
    }
